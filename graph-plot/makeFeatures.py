    ...
    for site in fold:
        ...
        for mthd in methods.keys():
            ...
            if methods[mthd][0] + "@" + methods[mthd][1] in debug.keys():
                methods[mthd][32] = debug[methods[mthd][0] + "@" + methods[mthd][1]][0][
                    0
                ]  # local
                methods[mthd][33] = debug[methods[mthd][0] + "@" + methods[mthd][1]][0][
                    1
                ]  # closure
                methods[mthd][34] = debug[methods[mthd][0] + "@" + methods[mthd][1]][0][
                    2
                ]  # global
                methods[mthd][35] = debug[methods[mthd][0] + "@" + methods[mthd][1]][0][
                    3
                ]  # script
            else:
